...
import { METRIC, FACT, ATTRIBUTE, DATE, BUCKETS } from "../../../constants/bucket";
...
import { removeInvalidSort } from "../../../utils/sort";
...
export class PluggableExperimentalNLG extends AbstractPluggableVisualization {
    ...
    public getExtendedReferencePoint(referencePoint: IReferencePoint): Promise<IExtendedReferencePoint> {
        ...
        if (dateItems.length) {
            ...
            attributes = getAllAttributeItemsWithPreference(buckets, [
                BucketNames.TREND,
                BucketNames.VIEW,
                BucketNames.SEGMENT,
                BucketNames.STACK,
        ...
        return Promise.resolve(sanitizeUnusedFilters(extendedRefrencePoint, clonedReferencePoint));
    }
